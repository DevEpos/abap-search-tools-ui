...
//		});
	...
	protected void initializeImageRegistry(final ImageRegistry imageRegistry) {
		...
		registerImage(imageRegistry, IImages.REFRESH, "icons/Refresh.png");
		...
		registerImage(imageRegistry, IImages.SEARCH_HISTORY, "icons/SearchHistory.png");
		...
		registerImage(imageRegistry, IImages.PUBLIC_COMPONENT, "icons/PublicComponent.png");
		...
		registerImage(imageRegistry, IImages.EXPAND_ALL, "icons/ExpandAll.png");
		registerImage(imageRegistry, IImages.COLLAPSE_ALL, "icons/CollapseAll.png");
		...
		registerImage(imageRegistry, IImages.SUB_TYPE, "icons/SubType.png");
