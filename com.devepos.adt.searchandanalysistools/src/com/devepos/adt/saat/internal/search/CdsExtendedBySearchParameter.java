 ...
 * @author stockbal
 */
public class CdsExtendedBySearchParameter extends NamedItemProposalProvider implements ISearchParameter, ISearchProposalProvider {
	...
	protected IContentProposal createProposalFromNamedItem(final INamedItem item, final String query) {
		return new SearchParameterProposal(item.getName(), this.parameterName, null, item.getDescription(), null, query);
	}
