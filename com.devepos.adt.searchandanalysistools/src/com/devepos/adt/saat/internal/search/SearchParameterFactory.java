...
public class SearchParameterFactory {
	...
	public static ISearchParameter createHasParameterParameter() {
		return new BooleanSearchParameter(QueryParameterName.HAS_PARAMS,
			MessageFormat.format(Messages.SearchPatternAnalyzer_DescriptionParamsParameter_xmsg,
...
//		parameter.setSupportsNegatedValues(true);
	...
	public static ISearchParameter createFriendParameter() {
		return new SearchParameter(QueryParameterName.FRIEND,
			MessageFormat.format(Messages.SearchPatternAnalyzer_DescriptionFriendParameter_xmsg,
				QueryParameterName.FRIEND.getLowerCaseKey()),
			SearchAndAnalysisPlugin.getDefault().getImage(IImages.FRIEND), true, true, true);
	}
	...
	public static ISearchParameter createInterfaceParameter() {
		return new SearchParameter(QueryParameterName.INTERFACE,
			MessageFormat.format(Messages.SearchPatternAnalyzer_DescriptionInterfaceParameter_xmsg,
				QueryParameterName.INTERFACE.getLowerCaseKey()),
			SearchAndAnalysisPlugin.getDefault().getImage(IImages.INTERFACE), true, true, true);
	}
	...
	public static ISearchParameter createMethodParameter() {
		return new SearchParameter(QueryParameterName.METHOD,
			MessageFormat.format(Messages.SearchPatternAnalyzer_DescriptionMethodParameter_xmsg,
				QueryParameterName.METHOD.getLowerCaseKey()),
			SearchAndAnalysisPlugin.getDefault().getImage(IImages.METHOD), true, true, true);
	}
	...
	public static ISearchParameter createAttributeParameter() {
		return new SearchParameter(QueryParameterName.ATTRIBUTE,
