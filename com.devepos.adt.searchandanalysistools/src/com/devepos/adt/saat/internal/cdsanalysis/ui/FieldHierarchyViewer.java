...
public class FieldHierarchyViewer extends TreeViewer {
	 ...
	 */
	public void initContextMenu(final IMenuListener menuListener, final String popupId, final IWorkbenchPartSite viewSite) {
	...
	private void createColumn(final int columnIndex, final String headerText, final int width) {
		...
		viewerColumn
			.setLabelProvider(new DelegatingStyledCellLabelProvider(new FieldHierarchyViewerCellLabelProvider(columnIndex)));
	 ...
	 * @author stockbal
	 */
	class FieldHierarchyViewerCellLabelProvider extends StyledCellLabelProvider implements IStyledLabelProvider {
	...
	class FieldHierarchyViewerContentProvider extends LazyLoadingTreeContentProvider {
		public FieldHierarchyViewerContentProvider() {
			super(LazyLoadingRefreshMode.ROOT_AND_NON_LAZY_CHILDREN, TreeViewer.ALL_LEVELS);
		}
