...
public class CdsTopDownAnalysisView extends CdsAnalysisPage<CdsTopDownAnalysis> {
  ...
  public CdsTopDownAnalysisView(final CdsAnalysisView parentView) {
    ...
    propertyChangeListener = event -> {
      if (SHOW_ALIAS_NAMES_PREF_KEY.equals(event.getProperty()) || SHOW_DESCRIPTIONS_PREF_KEY
  ...
  protected void createActions() {
    ...
    showDescriptions = new PreferenceToggleAction(
        Messages.CdsTopDownAnalysisView_ShowDescriptionsToggleAction_xmit, null,
        SHOW_DESCRIPTIONS_PREF_KEY, true, prefStore);
    showAliasNames = new PreferenceToggleAction(
        Messages.CdsTopDownAnalysisView_ShowAliasNamesToggleAction_xmit, null,
        SHOW_ALIAS_NAMES_PREF_KEY, true, prefStore);
    loadAssociations = new PreferenceToggleAction(
