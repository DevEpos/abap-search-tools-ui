...
public class ManageCdsAnalysesDialog extends StatusDialog {
    ...
    protected Control createDialogArea(final Composite container) {
        ...
        maxHistorySizeText.setText(String.valueOf(prefStore.getInt(IPreferences.MAX_CDS_ANALYZER_HISTORY)));
        maxHistorySizeText.addModifyListener(e -> {
            validateDialogState();
        });
        GridDataFactory.fillDefaults().hint(convertWidthInCharsToPixels(4), SWT.DEFAULT).applyTo(maxHistorySizeText);
