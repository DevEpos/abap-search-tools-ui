...
public class ObjectSearchResultPage extends Page implements ISearchResultPage, ISearchResultListener,
    ...
    private void initializeActions() {
        ...
        expandAllAction.setViewer(searchResultTree);
    ...
    private void createResultTree(final Composite parent) {
        ...
        searchResultTree.setLabelProvider(new DelegatingStyledCellLabelProvider(new ViewLabelProvider()));
    ...
    private void updateUiState() {
        Display.getDefault().asyncExec(() -> {
            ...
            searchResultTree.getControl().setFocus();
            final IAdtObjectReferenceNode[] result = this.result.getResultForTree(groupByPackageAction.isChecked());
