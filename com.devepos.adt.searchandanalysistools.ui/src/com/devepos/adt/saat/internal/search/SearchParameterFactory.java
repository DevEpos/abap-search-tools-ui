...
public class SearchParameterFactory {
    ...
    public static ISearchParameter createDescriptionParameter() {
        return new SearchParameter(QueryParameterName.DESCRIPTION, MessageFormat.format(
            Messages.SearchPatternAnalyzer_DescriptionDescriptionParameter_xmsg, QueryParameterName.DESCRIPTION
                .getLowerCaseKey(), "*material*"), //$NON-NLS-1$
    ...
    public static ISearchParameter createHasParameterParameter() {
        return new BooleanSearchParameter(QueryParameterName.HAS_PARAMS, MessageFormat.format(
            Messages.SearchPatternAnalyzer_DescriptionParamsParameter_xmsg, QueryParameterName.HAS_PARAMS
                .getLowerCaseKey(), "true"), //$NON-NLS-1$
    ...
    public static ISearchParameter createCdsParamParameter() {
        return new SearchParameter(QueryParameterName.CDS_PARAMETER, MessageFormat.format(
            Messages.SearchPatternAnalyzer_DescriptionParamParameter_xmsg, QueryParameterName.CDS_PARAMETER
                .getLowerCaseKey(), "p_plant"), //$NON-NLS-1$
    ...
    public static ISearchParameter createCdsTypeParameter(final IAbapProjectProvider projectProvider) {
        ...
        parameter.setDescription(MessageFormat.format(Messages.SearchPatternAnalyzer_DescriptionCdsTypeParameter_xmsg,
            QueryParameterName.TYPE.getLowerCaseKey(), "function")); //$NON-NLS-1$
    ...
    public static ISearchParameter createTableTypeParameter(final IAbapProjectProvider projectProvider) {
        ...
        parameter.setDescription(MessageFormat.format(Messages.SearchPatternAnalyzer_DescriptionTableTypeParameter_xmsg,
            QueryParameterName.TYPE.getLowerCaseKey(), "table")); //$NON-NLS-1$
        parameter.setImage(SearchAndAnalysisPlugin.getDefault().getImage(IImages.TYPE_PARAM));
//		parameter.setSupportsNegatedValues(true);
        return parameter;
    }
    ...
    public static ISearchParameter createClassCategoryParameter(final IAbapProjectProvider projectProvider) {
        ...
        parameter.setDescription(MessageFormat.format(
            Messages.SearchPatternAnalyzer_DescriptionClassCategoryParameter_xmsg, QueryParameterName.CATEGORY
                .getLowerCaseKey()));
     ...
     * @return the created parameter instance
     */
    public static ISearchParameter createAbapLanguageParameter(final IAbapProjectProvider projectProvider) {
        final NamedItemParameter parameter = new NamedItemParameter(projectProvider, QueryParameterName.ABAP_LANGUAGE,
            NamedItemType.ABAP_CLASS_LANGUAGE, true, ""); //$NON-NLS-1$
        parameter.setDescription(MessageFormat.format(Messages.SearchPatternAnalyzer_DescriptionAbapLangParameter_xmsg,
     ...
     * @return the created parameter instance
     */
    public static ISearchParameter createClassTypeParameter(final IAbapProjectProvider projectProvider) {
        final NamedItemParameter parameter = new NamedItemParameter(projectProvider, QueryParameterName.TYPE,
            NamedItemType.CLASS_TYPE, true, ""); //$NON-NLS-1$
        parameter.setDescription(MessageFormat.format(Messages.SearchPatternAnalyzer_DescriptionClassTypeParameter_xmsg,
            QueryParameterName.TYPE.getLowerCaseKey()));
        parameter.setImage(SearchAndAnalysisPlugin.getDefault().getImage(IImages.TYPE_PARAM));
        parameter.setSupportsNegatedValues(true);
        return parameter;
    }
     ...
     * @return the created parameter instance
     */
    public static ISearchParameter createClassFlagParameter(final IAbapProjectProvider projectProvider) {
        final NamedItemParameter parameter = new NamedItemParameter(projectProvider, QueryParameterName.FLAG,
    ...
    public static ISearchParameter createFriendParameter() {
        return new SearchParameter(QueryParameterName.FRIEND, MessageFormat.format(
            Messages.SearchPatternAnalyzer_DescriptionFriendParameter_xmsg, QueryParameterName.FRIEND
                .getLowerCaseKey()), SearchAndAnalysisPlugin.getDefault().getImage(IImages.FRIEND), true, true, true);
    }
    ...
    public static ISearchParameter createSuperTypeParameter() {
        return new SearchParameter(QueryParameterName.SUPER_TYPE, MessageFormat.format(
            Messages.SearchPatternAnalyzer_DescriptionSuperTypeParameter_xmsg, QueryParameterName.SUPER_TYPE
                .getLowerCaseKey()), SearchAndAnalysisPlugin.getDefault().getImage(IImages.SUPER_TYPE), true, true,
            true);
    }
    ...
    public static ISearchParameter createInterfaceParameter() {
        return new SearchParameter(QueryParameterName.INTERFACE, MessageFormat.format(
            Messages.SearchPatternAnalyzer_DescriptionInterfaceParameter_xmsg, QueryParameterName.INTERFACE
                .getLowerCaseKey()), SearchAndAnalysisPlugin.getDefault().getImage(IImages.INTERFACE), true, true,
            true);
    }
    ...
    public static ISearchParameter createMethodParameter() {
        return new SearchParameter(QueryParameterName.METHOD, MessageFormat.format(
            Messages.SearchPatternAnalyzer_DescriptionMethodParameter_xmsg, QueryParameterName.METHOD
                .getLowerCaseKey()), SearchAndAnalysisPlugin.getDefault().getImage(IImages.METHOD), true, true, true);
    }
    ...
    public static ISearchParameter createAttributeParameter() {
        return new SearchParameter(QueryParameterName.ATTRIBUTE, MessageFormat.format(
            Messages.SearchPatternAnalyzer_DescriptionAttributeParameter_xmsg, QueryParameterName.ATTRIBUTE
                .getLowerCaseKey()), SearchAndAnalysisPlugin.getDefault().getImage(IImages.ATTRIBUTE), true, true,
            true);
    }
    ...
    public static ISearchParameter createDeliveryClassParameter(final IAbapProjectProvider projectProvider) {
        ...
        parameter.setDescription(MessageFormat.format(
            Messages.SearchPatternAnalyzer_DescriptionDeliveryClassParameter_xmsg, QueryParameterName.DELIVERY_CLASS
                .getLowerCaseKey()));
