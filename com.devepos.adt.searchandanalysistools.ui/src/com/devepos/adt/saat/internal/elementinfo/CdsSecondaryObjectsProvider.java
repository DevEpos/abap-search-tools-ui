...
public class CdsSecondaryObjectsProvider implements IElementInfoProvider {
    ...
    public List<IElementInfo> getElements() {
        ...
        final IElementInfoCollection collection = service.retrieveCDSSecondaryElements(destinationId, cdsViewName);
        if (collection != null) {
    ...
    public String getProviderDescription() {
        return NLS.bind(Messages.ObjectSearch_LoadingRelatedObjectsProviderDescription_xmsg, cdsViewName);
    }
