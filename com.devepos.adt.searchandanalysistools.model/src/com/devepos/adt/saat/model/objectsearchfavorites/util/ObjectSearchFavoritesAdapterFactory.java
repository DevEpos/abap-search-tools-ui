...
import com.devepos.adt.saat.model.objectsearchfavorites.*;
...
public class ObjectSearchFavoritesAdapterFactory extends AdapterFactoryImpl {
	 ...
	 * @generated
	 */
	protected ObjectSearchFavoritesSwitch<Adapter> modelSwitch =
		new ObjectSearchFavoritesSwitch<Adapter>() {
			@Override
			public Adapter caseObjectSearchFavorites(IObjectSearchFavorites object) {
				return createObjectSearchFavoritesAdapter();
			}
			@Override
			public Adapter caseObjectSearchFavorite(IObjectSearchFavorite object) {
	...
	/**
	 * Creates a new adapter for an object of class '{@link com.devepos.adt.saat.model.objectsearchfavorites.IObjectSearchFavorites <em>Object Search Favorites</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link com.devepos.adt.saat.model.objectsearchfavorites.IObjectSearchFavorite <em>Object Search Favorite</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
