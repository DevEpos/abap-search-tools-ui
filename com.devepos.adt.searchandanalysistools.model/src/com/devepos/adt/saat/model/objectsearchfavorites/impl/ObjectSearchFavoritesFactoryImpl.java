 ...
 * @generated
 */
public class ObjectSearchFavoritesFactoryImpl extends EFactoryImpl implements IObjectSearchFavoritesFactory {
	/**
	...
	public static IObjectSearchFavoritesFactory init() {
		try {
			IObjectSearchFavoritesFactory theObjectSearchFavoritesFactory = (IObjectSearchFavoritesFactory)EPackage.Registry.INSTANCE.getEFactory(IObjectSearchFavoritesPackage.eNS_URI);
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case IObjectSearchFavoritesPackage.OBJECT_SEARCH_FAVORITES: return createObjectSearchFavorites();
			case IObjectSearchFavoritesPackage.OBJECT_SEARCH_FAVORITE: return createObjectSearchFavorite();
			default:
